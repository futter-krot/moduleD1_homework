...
# РАБОТА С ЗАДАЧЕЙ СОВЕРШАЕТСЯ ЛИШЬ В ФУНЦИИ move(), ВСЕ ОСТАЛЬНЫЕ ФУНКЦИИ НЕ ИМЕЮТ РАБОТЫ С ЗАДАЧАМИ, ДЛЯ ПРОВЕРКИ 3 ПУНКТА УСЛОВИЯ НУЖНО ИСПОЛЬЗОВАТЬ move() см. строку 60.
import requests, sys
